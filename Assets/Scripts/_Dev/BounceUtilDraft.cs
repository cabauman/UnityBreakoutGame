...
namespace BreakoutGame
{
    ...
    public class GeneralizedBounceStrategy : IBallPaddleCollisionStrategy
    {
        ...
        public void HandleCollision(BallPresenter ball, PaddlePresenter paddle, Vector2 point)
        {
            ...
            var bounceForce = PlaneBouncingUtilityDraft.CalculateHorizontalPlaneBounce(
                paddleCenter,
                paddle.Width,
                point,
                _maxBounceAngleRad,
    ...
    public class AngledPlaneBounceStrategy : IBallPaddleCollisionStrategy
    {
        ...
        public void HandleCollision(BallPresenter ball, PaddlePresenter paddle, Vector2 point)
        {
            ...
            var bounceForce = PlaneBouncingUtilityDraft.CalculateBounceDirection(
                paddleCenter,
                planeNormal,
                planeRight,
                paddle.Width,
    ...
    /// </summary>
    public static class PlaneBouncingUtilityDraft
    {
        /// <summary>
